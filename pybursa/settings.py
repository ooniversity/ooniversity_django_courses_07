...
SECRET_KEY = '+vmog^q7%5nqh@3m=p8^5*@hdi$)2-4@36)#j(1*t)ec3tju_*'
...
INSTALLED_APPS = ['coaches','students','courses','quadratic', 'polls.apps.PollsConfig', 'django.contrib.admin', 'django.contrib.auth',
